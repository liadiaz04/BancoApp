                ...
                saveButton.addActionListener(new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
                        ...
                        if (!validarNombre(gerente)) {
                            JOptionPane.showMessageDialog(null, "El nombre del gerente solo debe contener letras.", "Error de Validación", JOptionPane.ERROR_MESSAGE);
                            return;
                        }
                        ...
                        JOptionPane.showMessageDialog(addAgencyDialog, "Agencia agregada con éxito.", "Éxito", JOptionPane.INFORMATION_MESSAGE);
