...
public class Banco {
	...
	public  void loadClientes() {
        ...
        String[] carnets ={"44050202340", "08030377632", "75071813361", "93072021983", "96030623213", "04040178174", "65081033529",
        ...
        for (int i = 0; i < 20; i++) {
            String idCliente = carnets[i]; 
            clientes.add(new Cliente(idCliente, nombres[i], direcciones[i % direcciones.length],
